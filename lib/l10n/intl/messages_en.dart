...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(code) =>
      "Windows refused to run ForkFCCore.exe (error ${code}). An app control policy such as Smart App Control or AppLocker blocks unsigned programs; allow ForkFC in that policy or turn it off, then try again.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "coreBlockedBySmartAppControlTip": MessageLookupByLibrary.simpleMessage(
      "Windows Smart App Control blocked ForkFCCore.exe because it is not signed. Open Windows Security → App & browser control → Smart App Control settings, choose Off, then start ForkFC again. Smart App Control cannot be turned back on without reinstalling Windows.",
    ),
    ...
    "helperCorruptTip": MessageLookupByLibrary.simpleMessage(
      "Helper service unavailable; TUN mode cannot be enabled. Reinstall ForkFC to restore it.",
    ),
