...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(code) =>
      "Windows 拒绝运行 ForkFCCore.exe（错误 ${code}）。智能应用控制、AppLocker 等应用控制策略会拦截未签名程序，请在该策略中放行 ForkFC 或关闭策略后重试。";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "coreBlockedBySmartAppControlTip": MessageLookupByLibrary.simpleMessage(
      "Windows 智能应用控制拦截了未签名的 ForkFCCore.exe。请打开 Windows 安全中心 → 应用和浏览器控制 → 智能应用控制设置，选择「关闭」后重新启动 ForkFC。智能应用控制关闭后无法再开启，除非重装 Windows。",
    ),
    ...
    "helperCorruptTip": MessageLookupByLibrary.simpleMessage(
      "Helper 服务不可用，无法启用 TUN 模式，请重新安装 ForkFC。",
    ),
