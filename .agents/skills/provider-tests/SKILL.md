---
name: provider-tests
description: Use when adding or updating ForkFC Riverpod provider tests, notifier tests, or state-management tests in this repository.
---
...
- Do not use `dart test`; ForkFC models and provider tests may depend on Flutter types.
